...
class ClassCompanion1 {
    companion object Factory {
        fun create(): ClassCompanion1 = ClassCompanion1()
    }
}

class ClassCompanion2 {
    companion object {
        fun create(): ClassCompanion2 = ClassCompanion2()
    }
}
...
class ClassCompanion3 {
    companion object : InterfaceFactory<ClassCompanion3> {
        override fun create(): ClassCompanion3 = ClassCompanion3()
    }
}
