...
//    println(kotlinlang.sum(1, 2))
//    println(kotlinlang.multiply(2, 3))
//    println(kotlinlang.printSum(3, 4))
...
//    println(kotlinlang.maxOf(5, 6))

//    kotlinlang.printProduct("2", "asf")

//    val len = kotlinlang.getStringLength("123")
//    println(len)
...
//    println(kotlinlang.describe(1))
//    println(kotlinlang.describe(2))
//    println(kotlinlang.describe("Hello"))
//    println(kotlinlang.describe(2L))
//    println(kotlinlang.describe("heiheihei"))
...
//    val p = kotlinlang.Person("alice", 4)
////    val (name, age) = p // error
//    val model = kotlinlang.Model("apple", 10)
...
//    kotlinlang.tryCatchExpression()


//    kotlinlang.ifExpression(3)


//    kotlinlang.builderStyleUsage(3)


//    kotlinlang.singleExpression()


//    val shape = kotlinlang.Shape("rectangle", Color.RED.rgb)
//    with(shape) {
//        val s = toString()
//        val code = hashCode()
//        println(s)
...
//fun kotlinlang.maxOf(a: Int, b: Int): Int {
//    if (a > b) {
//        return a
//    } else {
//        return b
...
fun printTopLevelValue() {
    println("kotlinlang.getTop_level_var: $top_level_var")
    println("kotlinlang.getTop_level_val: $top_level_val")
}
