...
fun main(args: Array<String>) = runBlocking<Unit> {
    /********** demo 1 **********/
//    launch { println("%-25s: I'm working in thread ${Thread.currentThread().name}".format("kotlinlang.main runBlocking")) }
...
//        // not confined -- will work with kotlinlang.main thread
...
//    }
//    launch {
//        // context of the parent, kotlinlang.main runBlocking coroutine
//        println("%-25s: I'm working in thread ${Thread.currentThread().name}".format("kotlinlang.main runBlocking"))
//        delay(1000)
//        println("%-25s: After delay in thread ${Thread.currentThread().name}".format("kotlinlang.main runBlocking"))
//    }
...
//    delay(1000)
    ...
    /********** demo 11 **********/
//    threadLocal.set("kotlinlang.main")
//    println("Pre-kotlinlang.main, thread: ${Thread.currentThread()}, threadLocal value: ${threadLocal.get()}")
...
//    }
//    job.join()
//    println("Post-kotlinlang.main, thread: ${Thread.currentThread()}, threadLocal value: ${threadLocal.get()}\")")
}
