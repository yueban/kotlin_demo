...
import other.annotations.Ann
import other.annotations.AnnWithArrayValue
import other.annotations.AnnWithValue
...
class CAno2 {
    @Deprecated("this function is deprecated, use g instead", ReplaceWith("g"))
    fun f() {
    }
}
